...
with TaskGroup("data_collection", tooltip="Collect market and news data") as data_collection:
...
with TaskGroup("feature_engineering", tooltip="Process features") as feature_engineering:
...
with TaskGroup("label_generation", tooltip="Generate prediction labels") as label_generation:
...
with TaskGroup("model_training", tooltip="Train multiple models") as model_training:
